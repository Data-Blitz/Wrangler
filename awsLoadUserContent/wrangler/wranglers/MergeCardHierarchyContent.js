...
(function () {
    ...
    function resolveAttribute(anUnResolveAttribute) {
        resolvedAttribute = {};
        resolvedAttribute['cardname'] = anUnResolveAttribute.cardname;
        resolvedAttribute['chapterid'] = anUnResolveAttribute.chapterid;
        resolvedAttribute['eventid'] = anUnResolveAttribute.eventid;
