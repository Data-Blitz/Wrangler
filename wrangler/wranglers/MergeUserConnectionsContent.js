...
(function () {
    ...
    function resolveAttribute(anUnResolveAttribute) {
        resolvedAttribute = {};
        resolvedAttribute['dimensioncode'] = anUnResolveAttribute.dimensioncode;
        resolvedAttribute['dimensionname'] = anUnResolveAttribute.dimensionname;
        resolvedAttribute['dimensionscore'] = anUnResolveAttribute.dimensionscore;
