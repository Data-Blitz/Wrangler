...
(function () {
    ...
    function resolveAttribute(anUnResolveAttribute) {
        resolvedAttribute = {};
        resolvedAttribute['dimensioncode'] = anUnResolveAttribute.factorcode;
        resolvedAttribute['dimensionname'] = anUnResolveAttribute.factorname;
        resolvedAttribute['dimensionscore'] = anUnResolveAttribute.factorscore;
